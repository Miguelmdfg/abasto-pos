...
### Consideraciones
- Si el usuario está desactivado, mostrar mensaje: *"Tu cuenta está desactivada. Contacta al administrador."*
...
- Botones de método de pago:
  ...
  - Mixto
  - Fiado *(nuevo)*
- Botón de Cierre de Caja *(solo visible si hay caja abierta)*
...
- Si el stock es insuficiente, mostrar alerta: *"Stock insuficiente. Disponible: X unidades."*
...
4. Sistema registra la transacción con estado: *"Pendiente de verificación"* o *"Confirmado"* según configuración.
...
5. El sistema valida en tiempo real que la suma de los montos ingresados sea igual al total de la venta. Muestra: *"Falta: Bs X"* o *"Excede: Bs X"* hasta que cuadre.
6. Al cuadrar el monto, se habilita el botón *"Confirmar Pago Mixto"*.
...
7. El vendedor ve confirmación: *"Venta fiada registrada a nombre de [Cliente]."*
...
**Tablas principales:**
- usuarios, roles
- productos, categorías, movimientos_inventario
- ventas, detalle_ventas, métodos_pago
- clientes, deudas, abonos
