...
import { IconBoxes, IconChart, IconCosts, IconDebt, IconGrid, IconHistory, IconReceipt, IconSettings } from './icons';
    ...
    <aside className="flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
      ...
      <nav className="flex-1 space-y-1 px-4">
        {items.map((item) => {
          ...
          const inactive = 'text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800';
